...
This small `Silva`_ extension provides an interface in the management
interface to configure which Silva roles have the permission to add
which Silva content type.
